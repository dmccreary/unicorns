---
title: The Golem's Sprint Retrospective - The Ceremony Is the Product
description: A golem scrum master follows Agile perfectly. Sticky notes are written. Boards are photographed. Nothing changes. Fourteen months, zero shipped features. The ceremony continues.
image: /stories/the-golems-sprint-retrospective/cover.png
og:image: /stories/the-golems-sprint-retrospective/cover.png
twitter:image: /stories/the-golems-sprint-retrospective/cover.png
social:
   cards: false
---
...
1. Talk to the product owner directly. Not through Jira. In a room. With words.
2. Fix the CI pipeline. Actually fix it. This week. Not in a future sprint. Now.
3. Ship something small. Anything. A button. A color change. Proof of life.
4. Stop having meetings about meetings.
...
*"Continue the ceremony. Do not question the ceremony. The ceremony is the product."*
— The Parchment, Final Instruction, Author Unknown

*"What about the standup?"*
*"What about it?"*
— The Pixie and the Troll, the morning after Sprint 28

---

## References

1. [Scrum (Software Development)](https://en.wikipedia.org/wiki/Scrum_(software_development)) - An Agile framework consisting of prescribed ceremonies, artifacts, and roles that produce either working software or an impressive collection of sticky notes, depending on whether the organization treats the framework as a tool or a religion
2. [Cargo Cult](https://en.wikipedia.org/wiki/Cargo_cult) - The practice of replicating the superficial trappings of a phenomenon in the hope of reproducing its outcomes, which describes both Pacific Island rituals and organizations that hold daily standups without ever removing blockers
3. [Golem](https://en.wikipedia.org/wiki/Golem) - A creature from Jewish folklore animated by inscribed instructions, which follows those instructions without understanding, deviation, or soul — the original robotic process automation
4. [Retrospective (Software Development)](https://en.wikipedia.org/wiki/Retrospective#Software_development) - A meeting held at the end of each iteration to identify what went well, what didn't, and what to change, which functions as intended when changes are made and as theater when they are not
5. [Goodhart's Law](https://en.wikipedia.org/wiki/Goodhart%27s_law) - "When a measure becomes a target, it ceases to be a good measure" — applied to Agile: when the ceremony becomes the product, it ceases to produce anything except the ceremony
