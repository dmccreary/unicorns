...
|---|---------|-------|--------|-------|
| 1 | Concepts | 140 | Required | Concepts from learning graph |
| 2 | Chapters | 19 | Required | Chapter directories with index.md |
| 3 | MicroSims | 32 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 19 | Optional | Graphic-novel narratives in docs/stories/ |
...
| 7 | Glossary Terms | 145 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 85 | Recommended | Questions in faq.md |
| 9 | Words | 258,731 | Required | Words across student-facing markdown |
...
| Total Words | 258,731 | 94,600 | Words in markdown files |
| Links | 577 | 217 | Hyperlinks in markdown format |
| Equivalent Pages | 1058 | 402 | Estimated pages (250 words/page + visuals) |
