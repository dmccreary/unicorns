...
|-------------|-------|------|-------|
| Chapters | 19 | [Chapters](../chapters/index.md) | Number of chapter directories |
| Concepts | 140 | [Concept List](./concept-list.md) | Concepts from learning graph |
| Glossary Terms | 145 | [Glossary](../glossary.md) | Defined terms |
| FAQs | 85 | [FAQ](../faq.md) | Frequently asked questions |
| Quiz Questions | 190 | - | Questions across all chapters |
...
|-------------|-------------|---------------|-------|
| Diagrams | 31 | 31 | H4 headers starting with '#### Diagram:' |
| Equations | 1 | 0 | LaTeX expressions (inline and display) |
| Total Words | 147,859 | 94,583 | Words in markdown files |
| Links | 463 | 216 | Hyperlinks in markdown format |
| Equivalent Pages | 615 | 402 | Estimated pages (250 words/page + visuals) |
