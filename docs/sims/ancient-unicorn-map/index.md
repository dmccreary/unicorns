---
title: Ancient Unicorn Civilizations Map
description: Interactive Leaflet MicroSim for ancient unicorn civilizations map.
image: /sims/ancient-unicorn-map/ancient-unicorn-map.png
og:image: /sims/ancient-unicorn-map/ancient-unicorn-map.png
twitter:image: /sims/ancient-unicorn-map/ancient-unicorn-map.png
social:
   cards: false
quality_score: 0
---
...
[Run the Ancient Unicorn Civilizations Map MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
...
```html
<iframe src="https://dmccreary.github.io/unicorns/sims/ancient-unicorn-map/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
...
1. Thornbury, R. and Osei, P. (2019). *Cartographic Evidence for Cross-Cultural Unicorn Transmission in the Ancient Near East*. Journal of Premodern Cryptozoographic Studies, 14(2), 88–112. The authors note that transmission corridors correspond with remarkable fidelity to the routes later used for early international due diligence avoidance.

2. Almodovar-Singh, C. (2021). *Ctesias, Herodotus, and the Ethics of Field Reporting: When Your Source Is Someone Who Heard It From Someone Else*. Quarterly Review of Ancient Epistemology, 7(1), 34–51. Required reading for anyone who has ever cited a TechCrunch article in a board presentation.

3. Watanabe, K. and Mbuyi, F. (2023). *The Harappan Unicorn Seal: 2,000 Artifacts and Zero Explanations*. Proceedings of the International Symposium on Inconclusive Archaeological Evidence, 3, 201–218. The paper concludes, admirably, with the sentence: "Further research is needed."
