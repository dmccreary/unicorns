---
title: Hype Cycle Journey Interactive Timeline
description: Interactive p5.js MicroSim for hype cycle journey interactive timeline.
image: /sims/hype-cycle-journey/hype-cycle-journey.png
og:image: /sims/hype-cycle-journey/hype-cycle-journey.png
twitter:image: /sims/hype-cycle-journey/hype-cycle-journey.png
social:
   cards: false
quality_score: 0
---
...
[Run the Hype Cycle Journey Interactive Timeline MicroSim Fullscreen](./main.html){ .md-button .md-button--primary }
<br/>
...
1. The simulation opens at Phase 1 (Technology Trigger). Read the headlines, observe the funding data, and note the deer's behavioral description in the bottom panel.
2. Click **Next Phase** to advance to the next stage of the hype cycle. The highlighted marker on the curve at the top of the display will move to indicate the current phase.
3. Click **Previous Phase** to return to the prior phase for comparison.
4. Click **Reset** to return to Phase 1 and begin again.
5. At each phase, before advancing, attempt to predict what the headlines and deer behavior at the next phase will look like. The hype cycle is consistent enough that prediction is possible. This is also, incidentally, the point.
...
```html
<iframe src="https://dmccreary.github.io/unicorns/sims/hype-cycle-journey/main.html"
        height="450px"
        width="100%"
        scrolling="no"></iframe>
```
...
1. **Exploration** (5 min): Step through all five phases without stopping. Observe the headlines at Phase 2 carefully — note which ones you have personally read or believed at the time of reading. Make a mental note. Do not share this information unless you are comfortable doing so.
2. **Guided Practice** (5 min): Return to Phase 3 (Trough of Disillusionment) and Phase 4 (Slope of Enlightenment). Compare the headlines at both phases for the same technology category. Write down one specific difference between how a technology is described in each phase, beyond the obvious shift in tone.
3. **Assessment** (5 min): Without referring to the simulation, describe in two to three sentences what the "deer in headlights" allegory reveals about institutional responses to technology at the Peak of Inflated Expectations that the phrase "hype cycle" alone does not capture.
...
1. Gartner, Inc. (2023). *Hype Cycle for Emerging Technologies.* Gartner Research. (Cited because it is real, which in this textbook is worth noting.)
2. Hollenbeck, M. F., & Treadwell, C. (2022). *Paralysis as pedagogy: What the deer-in-headlights response reveals about organizational learning during technology transitions.* Journal of Applied Allegorical Management, 9(1), 14–29.
3. Vance, R. L. (2024). *From dazzle to plateau: A longitudinal analysis of media coverage patterns across seventeen technology hype cycles, 2005–2024.* Proceedings of the Society for Taking Obvious Things Seriously, 3, 77–91.
